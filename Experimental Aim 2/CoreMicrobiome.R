...
plot_unique_SPMS <- ggplot(summary_SPMS, aes(x = reorder(GenusSpecies, MeanAbundancePct), y= MeanAbundancePct)) +
  ...
  scale_x_discrete(labels = c("g__Tyzzerella_NA" = expression(italic("Coprococcus phoceensis")),
                              ...
                              "g__Porphyromonas_NA" = expression(italic("Porphyromonas sp.")),
                              ...
                              "g__Tyzzerella_s__unidentified" = expression(italic("Tyzzerella sp.")),
...
plot_unique_PPMS <- ggplot(summary_PPMS, aes(x = reorder(GenusSpecies, MeanAbundancePct), y = MeanAbundancePct)) +
  ...
  scale_x_discrete(labels = c("f__Prevotellaceae_g__Prevotella_NA" = expression(italic("Segatella copri")),
                              ...
                              "f__Bacteroidaceae_g__Bacteroides_s__Bacteroides_plebeius" = expression(italic("Bacteroides sp.")),
                              ...
                              "f__Lachnospiraceae_g__Blautia_s__Ruminococcus_sp." = expression(italic("Blautia sp.")),
                              "f__Izemoplasmatales_g__Izemoplasmatales_s__uncultured_organism" = expression(italic("Blautia faecis")),
                              "f__Christensenellaceae_g__Christensenellaceae_R-7_group_NA" = expression(italic("Christensenellaceae sp.")),
                              ...
                              "f__Eggerthellaceae_g__Adlercreutzia_NA" = expression(italic("Adlercreutzia sp.")),
                              "f__Ruminococcaceae_g__Negativibacillus_s__uncultured_bacterium" = expression(italic("Negativibacillus sp.")),
